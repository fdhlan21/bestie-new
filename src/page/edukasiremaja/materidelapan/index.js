...
const MateriDelapan = ({navigation}) => {
    const kembali = () => {
        navigation.goBack();
    }

const source = require('../../../../android/app/src/main/assets/pdf/8_anemia_new.pdf')
  ...
  return (
    <View style={{flex:1, backgroundColor:colors.primary}}>
     ...
     <View style={{}}>
     <TouchableOpacity onPress={kembali} style={{right:85, top:0}}>
     <Image style={{height:30, width:30, tintColor:'white'}} source={LeftArrow}/>
     </TouchableOpacity>
        
        <Text style={{fontFamily:'Poppins-SemiBold', color:'white', bottom:25}}>Materi 8 - Anemia new</Text>
     </View>
     </View>
