...
const MateriDua = ({navigation}) => {
    const kembali = () => {
        navigation.goBack();
    }

const source = require('../../../../android/app/src/main/assets/pdf/2_gizi.pdf')
  ...
  return (
    <View style={{flex:1, backgroundColor:colors.primary}}>
     ...
     <View style={{}}>
     <TouchableOpacity onPress={kembali} style={{right:115, top:0}}>
     <Image style={{height:30, width:30, tintColor:'white'}} source={LeftArrow}/>
     </TouchableOpacity>
        
        <Text style={{fontFamily:'Poppins-SemiBold', color:'white', bottom:25}}>Materi 2 - Gizi</Text>
     </View>
     </View>
