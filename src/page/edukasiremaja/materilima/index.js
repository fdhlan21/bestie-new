...
const MateriLima = ({navigation}) => {
    const kembali = () => {
        navigation.goBack();
    }

const source = require('../../../../android/app/src/main/assets/pdf/5_ims_hiv_aids_hepatitis_b_dan_c.pdf')
  ...
  return (
    <View style={{flex:1, backgroundColor:colors.primary}}>
     ...
     <Image style={{height:30, width:30, tintColor:'white'}} source={LeftArrow}/>
        ...
        <Text style={{fontFamily:'Poppins-SemiBold', color:'white', bottom:24, fontSize:12,}}>Materi 5 - IMS, HIV, AIDS, Hepatitis B dan C</Text>
     </View>
     </View>
