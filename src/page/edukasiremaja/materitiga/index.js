...
const MateriTiga = ({navigation}) => {
    const kembali = () => {
        navigation.goBack();
    }

const source = require('../../../../android/app/src/main/assets/pdf/3_napza.pdf')
  ...
  return (
    <View style={{flex:1, backgroundColor:colors.primary}}>
     ...
     <View style={{}}>
     <TouchableOpacity onPress={kembali} style={{right:105, top:0}}>
     <Image style={{height:30, width:30, tintColor:'white'}} source={LeftArrow}/>
     </TouchableOpacity>
        
        <Text style={{fontFamily:'Poppins-SemiBold', color:'white', bottom:25}}>Materi 3 - Napza</Text>
     </View>
     </View>
