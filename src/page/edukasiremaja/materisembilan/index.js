...
const MateriSembilan = ({navigation}) => {
    const kembali = () => {
        navigation.goBack();
    }

const source = require('../../../../android/app/src/main/assets/pdf/9_stunting.pdf')
  ...
  return (
    <View style={{flex:1, backgroundColor:colors.primary}}>
     ...
     <Image style={{height:30, width:30, tintColor:'white'}} source={LeftArrow}/>
        ...
        <Text style={{fontFamily:'Poppins-SemiBold', color:'white', bottom:25}}>Materi 9 - Stunting</Text>
     </View>
     </View>
